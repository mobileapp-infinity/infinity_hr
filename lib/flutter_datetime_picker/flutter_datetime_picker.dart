...
import 'package:infinity_hr/flutter_datetime_picker/src/date_model.dart';
import 'package:infinity_hr/flutter_datetime_picker/src/datetime_picker_theme.dart';
import 'package:infinity_hr/flutter_datetime_picker/src/i18n_model.dart';
...
//    print('refreshScrollOffset ${widget.pickerModel.currentRightIndex()}');
    ...
    return GestureDetector(
      child: AnimatedBuilder(
        ...
        builder: (BuildContext context, Widget? child) {
          final double? bottomPadding = MediaQuery.of(context).padding.bottom as double;
          return ClipRect(
  ...
  Widget _renderTitleActionsView(DatePickerTheme theme) {
    ...
    return Container(//this widget is for calender
